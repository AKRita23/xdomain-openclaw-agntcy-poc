...
Both layers enforced independently. Channel-bound scopes (`slack.post.agent-weather-alerts`, not `slack.post`). Subject propagation end-to-end for audit. Same orchestrator code runs against two different IdPs.
